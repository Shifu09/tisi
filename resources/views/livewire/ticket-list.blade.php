...
<div>
    ...
    @if($tickets->count() === 0)
        <div class="text-center py-12">
            ...
            <a href="/tickets/create" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                Crear Ticket
            </a>
        </div>
    @else
